...
export class BalanceteFinanceiroService {
  ...
  ResultadoBalanceteContabil(pInicial:string, pFinal: string, pPeriodicidade: string):Observable<any>{
    return this.service.get("BalanceteContabil/ResultadoBalanceteContabil", {pInicial: pInicial, pFinal : pFinal, pPeriodicidade : pPeriodicidade});
  }
}